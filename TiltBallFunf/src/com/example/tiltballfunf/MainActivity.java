...
public class MainActivity extends Activity {
	...
	public void onResume() {
		...
		timerTask = new TimerTask() {
			public void run() {
				// Debug on logcat
				android.util.Log.d("TiltBall", "Timer position - "
	...
	/*
	 * onConfiguraionChanged handler is called when user tilts phone enough to
	 * trigger landscape view however the app should stay portrait so ignore the
	 * event
	 */
